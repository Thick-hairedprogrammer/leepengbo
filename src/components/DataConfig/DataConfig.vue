<template>
  <div>
    ...
    <el-card>
      <el-row :gutter="20">
        <el-col :span="6">
          <el-input placeholder="请输入要查找的参数主键" v-model="queryInfo.query" clearable @clear="getUserList">
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column prop="username" label="参数主键"></el-table-column>
        <el-table-column prop="username" label="参数值"></el-table-column>
        <el-table-column prop="username" label="参数说明"></el-table-column>
